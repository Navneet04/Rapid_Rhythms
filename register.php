...
<script type="text/javascript" src="javascript/convform.js"></script>
<script type="text/javascript" src="javascript/custom.js"></script>
  ...
  <body>
        ...
        <nav id="mainNavbar" class="navbar navbar-expand-lg navbar-light shadow fixed-top shift animate_animated animateslideInDown animate_slower">
  ...
  <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-sm-8 ">
                    ...
                    <h2 class="animate_animated animate_bounce" style="text-align: center; padding-top: 140px; font-weight: bolder;">Register Yourself Today</h2>

                    <div class="form-container">
                        <form id="query-form" method ="POST" action="insert.php" class="contact">
                        <div class="mb-3 form-input">
                            <input type="text" name="name" id="exampleFormControlInput1" placeholder="Enter your name" required>
                        </div>
                        <div class="mb-3 form-input">
                            <input type="email" name="email" id="exampleFormControlInput2" placeholder="Enter your Email-Id" required>
                        </div>
                        <div class="mb-3 form-input">
                            <input type="tel" name="phone" id="exampleFormControlTextarea1" placeholder="Your Phone No" required></textarea>
                        </div>
...
<div class="chat_box">
	<div class="my-conv-form-wrapper">
      ...
      <div data-conv-fork="category">
        <div data-conv-case="Work">
          <input type="text" name="danceArea" data-conv-question="Please, tell me your form of dance ">    
        </div>
        <div data-conv-case="Learning" data-conv-fork="first-question2">
          <input type="text" name="form" data-conv-question="Please, enter your interested dance form"> 
        </div>
      </div>
                      ...
                      <div class="logo-widget footer-widget">
                          <div class="widget-content">
                              ...
                              <ul class="social-links">
                                  <li><a href="https://www.facebook.com/StanceDanceStudio"><i class="fab fa-facebook-f"></i></a></li>
                                  <li><a href="https://twitter.com/stancedance_sds"><i class="fab fa-twitter"></i></a></li>
                                  <li><a href="https://www.youtube.com/channel/UCwrq_CfSrfaDpxoNzU1pleg/feed"><i class="fab fa-youtube"></i></a></li>
                                  <li><a href="https://www.instagram.com/stancedancestudio.official/"><i class="fab fa-instagram"></i></a></li>
                              </ul>
                          </div>
                      </div>
                  </div>
